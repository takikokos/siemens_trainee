...
if __name__ == "__main__":
    ...
    result, eval_time = s.find_patt(p, with_dwt=True, use_fastdtw=False)
    print(f"Found at {result:.2f} sec, execution time : {eval_time:.2f} sec")
    s.draw_waveform_plotly("demo.html", select_interval=[result, result+p.duration])