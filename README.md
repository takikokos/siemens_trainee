...
Реализованы чтение/запись(одноканальная) файла в формате .wav
...
расстояние между рядами и уменьшает размер данных). Поиск осуществляется простым перебором, для оценки схожести 
...
Для демонстрации работы алгоритмов можно запустить main.py, все зависимости для python3 указаны в requirements.txt, также для работы библиотеки sox необходим установленный sox на линукс (apt-get install sox). 
